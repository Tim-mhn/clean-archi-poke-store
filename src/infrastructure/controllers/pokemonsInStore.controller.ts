...
export class PokemonsInStoreController {
    constructor(
        @Inject(PokemonRepositoryProxy.getInstance) private readonly pokemonRepository: IPokemonRepository,
        @Inject(StoreRepositoryProxy.getInstance) private readonly storeRepository: IStoreRepository,
